...
hist(x$steps, lwd = 7, ylab="Frequency (steps)", xlab="steps",main="Total steps per day",col="pink")
```
...
hist(imputedsum$ste, lwd = 7, ylab=" Frequency", xlab="steps",main="Total steps per day with NA's fixed")
```
